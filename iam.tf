    ...
    policy = jsonencode({
      ...
      Statement = [
        ...
        },
        {
          ...
          Resource = "arn:${var.partition}:s3:::${aws_s3_bucket.cost_and_usage_report.id}/opencost-prefix/opencost-prefix/opencost-report/eks-cost-usage-report-${var.account_id}/eks-cost-usage-report-${var.account_id}*"
        }
      ]
    })
  }
